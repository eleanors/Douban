...
var MusicCategory = require('../../models/music/music_category'),
// 音乐数据模型
...
exports.save = function(req, res) {
        ...
        // 获取当前填写的音乐分类
        programmeId = musicCategoryObj.programmeId,
        // 获取填写的音乐榜单分类ID
        programmeName = musicCategoryObj.programmeName,
        // 获取榜单分类名
